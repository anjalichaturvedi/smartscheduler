    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse move-me">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li class="dropdown">
    <a class="dropdown-toggle" aria-expanded="false">ALLOTMENT<span class="caret"></span></a>
    <ul>
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    <div class="form-group">
                        ...
                        <input style="margin-left:-33px;" type="text" class="form-control" id="teachername" name="TN"
                               placeholder="Teacher's Name ...">
                    </div>
                    <div class="form-group">
                        <label for="TF">Faculty No</label>
                        <input style="margin-left:0px;"  type="text" class="form-control" id="facultyno" name="TF" placeholder="Faculty No ...">
                    </div>
                    <div class="form-group">
                        <label for="TF">Alias</label>
                        <input  style="margin-left:33px;"  type="text" class="form-control" id="alias_name" name="AL" placeholder="Alias..">
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="designation">Designation</label>

                        <select  style="margin-left:-10px;"  class="form-control" id="designation" name="TD">
                    ...
                    <div class="form-group">
                        ...
                        <input  style="margin-left:-10px;"  type="text" class="form-control" id="teachercontactnumber" name="TP"
                               placeholder="+91 ...">
                    </div>

                    <div class="form-group">
                        <label for="teacheremailid">Email-ID</label>
                        <input  style="margin-left:10px;" type="text" class="form-control" id="teacheremailid" name="TE"
