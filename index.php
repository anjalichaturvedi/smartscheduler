...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center" style="margin-top: 200px;    font-size: 2em;
">
            <h3 align="center">Welcome to Time Table Management System!</h3>
        </div>
    </div>
</div>
...
<div id="footer" style="text-align: center;">
    <p>Made with ❤ by Anjali Chaturvedi and Vibhu Chaudhary</p>
</div>
<!-- FOOTER SECTION END-->
