            ...
            <div style="display:none" id="addSubjectForm">
                <form action="addsubjectFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select  style="margin-left:22px;"  class="form-control" id="subjectsemester" name="SS">
                            <option selected disabled>Select</option>
                    ...
                    <div class="form-group">
                        ...
                        <select  style="margin-left:5px;" class="form-control" id="subjectdepartment" name="SD">
                            <option selected disabled>Select</option>
